...
- TFTP 서비스와 PXE·장비 설정·백업 파일명 단서가 있을 때.
- FTP·웹·SMB·SNMP에서 TFTP 파일명이나 장비명을 얻었을 때.
- UDP 스캔 상태와 실제 파일 읽기 성공을 구분해야 할 때.
...
| 전송 결과 | 로컬 파일 생성과 내용 | 파일 크기·hash 확인 | 빈 파일·중단 전송을 제외 |
