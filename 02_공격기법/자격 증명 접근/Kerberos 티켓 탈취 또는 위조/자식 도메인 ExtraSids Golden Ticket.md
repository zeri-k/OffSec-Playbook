...
- `Default principal`이 `<CHILD_USER>@<CHILD_REALM>`과 일치하고 자식 도메인 TGT가 유효하다.
...
| 관찰 | 판단 | 결과 상태 | 다음 행동 |
|---|---|---|---|
| ccache 생성과 `klist`의 자식 TGT | Golden TGT 생성 성공 | ticket 파일 보유 | 부모 service ticket과 리소스 접근 확인 |
